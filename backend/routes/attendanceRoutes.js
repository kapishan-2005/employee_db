...
// GET attendance report - admin and manager only
router.get("/report", authMiddleware, requireRole('admin', 'manager'), controller.getAttendanceReport);
...
// PUT update attendance - admin and manager only
router.put("/:id", authMiddleware, requireRole('admin', 'manager'), controller.updateAttendance);
